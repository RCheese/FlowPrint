...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ratio", type=float, default=0.5, help="train ratio of data (default=0.5)"
    )
    parser.add_argument(
        "--random", action="store_true", help="split randomly instead of sequentially"
    )
    ...
    # Perform temporal split split
        ...
        for app in np.unique(y):
            ...
            print(
                "Split {:40} into {} train and {} test flows".format(
    ...
    flowprint = FlowPrint(batch=300, window=30, correlation=0.1, similarity=0.9)
